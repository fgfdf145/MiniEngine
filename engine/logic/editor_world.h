...
class IEditorWorld : public IEditorLogicLayer, public ISceneWorld
{
  public:
    ...
    {
        return GetModel(GetSelectedEntity());
    }
    const ModelBoundsComponent& GetSelectedModelBounds() const
    {
        return GetModelBounds(GetSelectedEntity());
    }
    const EditorModelMetadataComponent& GetSelectedModelMetadata() const
    {
        return GetModelMetadata(GetSelectedEntity());
    }
    ...
    const LightComponent& GetLightComponent(entt::entity entity) const
    {
        return Registry().get<LightComponent>(entity);
    }
